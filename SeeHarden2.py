...
def informacion(ev):
    ...
    informacion.text_detalles.pack(pady=30)
...
etiqueta_descripcion = tk.Label(frame_principal, text=descripcion_predeterminada, justify="center", wraplength=400,font=("Arial", 11))
...
with open("imagenes/recomendaciones.txt", 'r', encoding='utf-8') as procfile:
